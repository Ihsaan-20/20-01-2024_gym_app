    ...
    <form action="{{ route('form.store') }}" method="POST" enctype="multipart/form-data" class="px-3">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" value="{{ old('program_name') }}" name="program_name" />
                    @error('program_name')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Leave a comment here" name="program_text_bio"
                            id="floatingTextarea">{{ old('program_text_bio') }}</textarea>
                        <label for="floatingTextarea">Comments</label>
                        @error('program_text_bio')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    @error('program_profile')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-3 col-md-6">
                    <label for="timeInput" class="form-label">Duration</label>
                    <input type="time" value="{{ old('program_duration') }}" name="program_duration" class="form-control" />
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="tel" class="form-control" id="usdPrice" value="{{ old('program_price') }}" name="program_price" placeholder="1"
                ...
                <div class="accordion-body">
                    ...
                    <div class="row mb-3 bg-light py-3 rounded-3">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <span class="text-muted">Video is required</span>
                        </div>
                        <div class="mb-3 col-md-6">
